$(document).ready(function () {
    ...
    var but = len.length;
    if (but == 3) {
        $(".Invitation_info").animate({marginTop: "42px", opacity: "1"});
        len.css({marginTop: "18%"});
    } else if (but == 2) {
        $(".Invitation_info").animate({marginTop: "52px", opacity: "1"});
        len.css({marginTop: "30%"});
    } else {
        $(".Invitation_info .pic-opa-titles").each(function () {
            $(this).text($.trim($(this).text()));
            font_length(19, $(this))
        });
        len.css({marginTop: "12%"});
    }
    $(".Invitation_info").animate({marginTop: "42px", opacity: "1"}, 1200, function () {
        $(".Invitation_button").animate({opacity: "1"}, 600, function () {
            $(".share_event ul li").eq(0).animate({
                opacity: "1"
            },500, function () {
                $(".share_event ul li").eq(1).animate({
                    opacity: "1"
                },500, function () {
                    $(".share_event ul li").eq(2).animate({
                        opacity: "1"
                    })
                })
            })
