...
require(
    ...
    function (ec,theme) {
        ...
        var myChart = ec.init(document.getElementById('right_curveoforder_5'),theme);
        city();
        function city() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for(var i=0;i<data.city.length;i++){
                        ...
                        data_val.push({'name':data.city[i].city,value:data.city[i].value})
                    }
                    for(var i=0;i<data.top.length;i++){
                        data_val.push({'name':data.top[i].city,value:data.top[i].value})
                        data_geoCoord[data.top[i].city]=[data.top[i].location.lon,data.top[i].location.lat]
                    }
                    var max=data.top[0].value
                    var option = {
                        tooltip : {
                            trigger: 'item'
                        },
                        ...
                        series : [
                            ...
                            //            return (v>100000)?v/10000:v/1000
                            //        },
                            //        effect : {
                            //            show: false,
                            //            shadowBlur : 0
