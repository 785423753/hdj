...
$("#apply").click(function () {
    ...
    $("#freeForm").fadeIn(200)
    $("#codeImg").attr("src","/get_check_code_image/?position=freesubmit")
})
...
$("#post").click(function () {
    ...
    }else if ($.trim($("#company").val()).length == 0) {
        option.content = "单位不能为空"
        $("#company").popover(option).popover('show')
    }else if ($.trim($("#job").val()).length == 0) {
...
//收藏        author:moubo  time:02/01 17:30
