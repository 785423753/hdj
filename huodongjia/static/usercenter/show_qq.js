(function(a, c) {
    ...
    var i = function() {
        var p = {};
        l("Boolean Number String Function Array Date RegExp Object".split(" "),
            function(s, r) {
    ...
    h("lang.typeEnhance", "lang.each",
        function() {
            return i
        });
    h("util.serialize", "lang.each,lang.typeEnhance",
        function() {
            return o
        });
    h("util.report",
    ...
    h("util.log", "globalSettings,lang.each,lang.typeEnhance,util.report",
        function() {
            return f
        });
    h("util.pubSub", "lang.each",
        function() {
            return j
        });
    h("util.speedReport", "util.report",
        function(r) {
            var p = r("report");
    ...
    h("util.combo", "globalSettings,util.getScript",
        function(q) {
            ...
            return function(v, y, A) {
                for (var x = 0,
                         t = Math.ceil(y.length / r), z, u; x < t; x++) {
                    z = r * x;
    ...
    h("util.getRequireList", "globalSettings",
        function(p) {
    ...
    h("api.require", "globalSettings,lang.each,lang.trim,lang.typeEnhance,util.pubSub,util.combo,util.getRequireList",
        function(s) {
    ...
    h("api.define", "lang.typeEnhance,api.require,util.pubSub",
        function(q) {
            var s = q("typeEnhance"),
                r = q("api.require"),
                p = q("util.pubSub");
    ...
    h("api.set", "lang.each,globalSettings",
        function(p) {
            var q = p("each");
    ...
    h("api.setVersion", "globalSettings",
        function(p) {
    ...
    h("api.setResourceMap", "globalSettings",
        function(p) {
            var r = p("globalSettings");
            var q = r.global;
    ...
    h("api.load", "api.require,globalSettings,util.speedReport",
        function(s) {
            var B = s("require"),
                t = s("globalSettings"),
                r = s("speedReport");
            ...
            return p.load = function(C) {
                ...
                var D = r("7818", "21", "1");
                B("util.speedReport,util.domain,wpa.wpaMgr,wpa.visitor,wpa.kfuin",
                    function(E) {
                        D.addPoint(2).send();
                        var J = E("wpaMgr"),
                            I = E("visitor"),
    ...
    h("wpa.APIs", "globalSettings,lang.each,api.require,util.pubSub,util.speedReport",
        function(s) {
...
BizQQWPA.setVersion("3.3.7.20160126").load({
    "wty": "1",
    "kfuin": "938161505",
    "nameAccount": "4000033879",
    "type": "30",
    "sv": "4",
    "title": "",
    "aty": "0",
    "a": "0",
    "ws": "http:\/\/www.huodongjia.com\/",
    "btn1": "",
    "btn2": "",
    "fsty": "0",
    "fposX": "0",
